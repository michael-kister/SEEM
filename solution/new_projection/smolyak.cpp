...
void Monomial::print_receipt(double* coeff) const
{
    *coeff = coeff_total;
}

void Monomial::print_receipt(double* coeff, int* deg1, int* deg2) const
{
    *coeff = coeff_total;
    
    *deg1  = MonIndex::operator[](0);
    *deg2  = MonIndex::operator[](1);
}

void Monomial::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3) const
{
    *coeff = coeff_total;
    
    *deg1  = MonIndex::operator[](0);
    *deg2  = MonIndex::operator[](1);
    *deg3  = MonIndex::operator[](2);
}

void Monomial::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3, int* deg4) const
{
    *coeff = coeff_total;
    ...
    *deg2  = MonIndex::operator[](1);
    *deg3  = MonIndex::operator[](2);
    *deg4  = MonIndex::operator[](3);
}

void Monomial::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3, int* deg4, int* deg5) const
{
    *coeff = coeff_total;
    ...
    *deg3  = MonIndex::operator[](2);
    *deg4  = MonIndex::operator[](3);
    *deg5  = MonIndex::operator[](4);
}

void Monomial::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3, int* deg4, int* deg5, int* deg6) const
{
    *coeff = coeff_total;
...
void FunctionGrid::print_receipt(double* coeff) const
{
    int i = 0;
    for (const auto& it : *this) {
	it.second.print_receipt(coeff+i);
	++i;
    }
}

void FunctionGrid::print_receipt(double* coeff, int* deg1, int* deg2) const
{
    int i = 0;
    for (const auto& it : *this) {
	it.second.print_receipt(coeff+i, deg1+i, deg2+i);
	++i;
    }
}

void FunctionGrid::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3) const
{
    int i = 0;
    for (const auto& it : *this) {
	it.second.print_receipt(coeff+i, deg1+i, deg2+i, deg3+i);
	++i;
    }
}

void FunctionGrid::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3, int* deg4) const
{
    int i = 0;
    for (const auto& it : *this) {
	it.second.print_receipt(coeff+i, deg1+i, deg2+i, deg3+i, deg4+i);
	++i;
    }
}

void FunctionGrid::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3, int* deg4, int* deg5) const
{
    int i = 0;
    for (const auto& it : *this) {
	it.second.print_receipt(coeff+i, deg1+i, deg2+i, deg3+i, deg4+i, deg5+i);
	++i;
    }
}

void FunctionGrid::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3, int* deg4, int* deg5, int* deg6) const
{
    int i = 0;
    for (const auto& it : *this) {
	it.second.print_receipt(coeff+i, deg1+i, deg2+i, deg3+i, deg4+i, deg5+i, deg6+i);
	++i;
    }
}
...
void Approximation::print_receipt(double* coeff) const
{
    fun_grid.print_receipt(coeff);
}

void Approximation::print_receipt(double* coeff, int* deg1, int* deg2) const
{
    if (dim == 2) {
	fun_grid.print_receipt(coeff, deg1, deg2);
    } else {
	printf("Cannot attempt to print approximation; wrong number of receipts.\n");
	printf("Dimension of approximation....... %d\n", dim);
	printf("Number of vectors for receipts... 2\n");
    }
}

void Approximation::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3) const
{
    if (dim == 3) {
	fun_grid.print_receipt(coeff, deg1, deg2, deg3);
    } else {
	printf("Cannot attempt to print approximation; wrong number of receipts.\n");
	printf("Dimension of approximation....... %d\n", dim);
	printf("Number of vectors for receipts... 3\n");
    }
}

void Approximation::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3, int* deg4) const
{
    if (dim == 4) {
	fun_grid.print_receipt(coeff, deg1, deg2, deg3, deg4);
    } else {
	printf("Cannot attempt to print approximation; wrong number of receipts.\n");
	printf("Dimension of approximation....... %d\n", dim);
	printf("Number of vectors for receipts... 4\n");
    }
}

void Approximation::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3, int* deg4, int* deg5) const
{
    if (dim == 5) {
	fun_grid.print_receipt(coeff, deg1, deg2, deg3, deg4, deg5);
    } else {
	printf("Cannot attempt to print approximation; wrong number of receipts.\n");
	printf("Dimension of approximation....... %d\n", dim);
	printf("Number of vectors for receipts... 5\n");
    }
}

void Approximation::print_receipt(double* coeff, int* deg1, int* deg2, int* deg3, int* deg4, int* deg5, int* deg6) const
{
    if (dim == 6) {
	fun_grid.print_receipt(coeff, deg1, deg2, deg3, deg4, deg5, deg6);
    } else {
	printf("Cannot attempt to print approximation; wrong number of receipts.\n");
	printf("Dimension of approximation....... %d\n", dim);
	printf("Number of vectors for receipts... 6\n");
    }
}
